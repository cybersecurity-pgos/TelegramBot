...
BOT_TOKEN: str = os.getenv("BOT_TOKEN", "8737099647:AAG4_Tkr20ElvzJMx1gBysu1H8MYGC4rjKA")
ADMIN_CHAT_ID_STR: str = os.getenv("ADMIN_CHAT_ID", "8353391073")

if not BOT_TOKEN:
    raise ValueError("BOT_TOKEN mancante nel file .env")

if not ADMIN_CHAT_ID_STR:
    raise ValueError("ADMIN_CHAT_ID mancante nel file .env")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_photo(
        photo="https://i.imgur.com/xOZs5rk.png",  # <-- sostituisci con URL o file_id del tuo stemma
        caption="🔐 <b>TracerTheLeak Security</b>\n\n<b>Welcome!</b>",
